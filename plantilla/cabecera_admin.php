        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav mr-auto ml-auto text-center ">
                <!-- <li class="nav-item active">
                    <a class="nav-link" href="../administrativo/menu/index.php">INICIO <span class="sr-only">(current)</span></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="../administrativo/menu/servicio.php">SERVICIO</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="../administrativo/menu/nosotros.php">QUIENES_SOMOS</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="../menu/contacto.php">CONTACTOS</a>
                </li>
                <li class="nav-item"> -->
